...
function commitFormatMode() {
  ...
  const btn = document.getElementById('fmtBtn');
  if (btn) {
    btn.textContent = 'Formats';
    btn.classList.remove('active');
  }

  // Commit current timer state as new defaults
  ...
  // Commit daily list titles/colors/tasks as new defaults
  // (they're already mutated in-place via oninput handlers)
...
function openCalModal(dateKey, evId, defaultStart) {
  ...
  if (evId) {
    ...
    document.getElementById('calEventTemplate').checked = !!ev.isTemplate;
